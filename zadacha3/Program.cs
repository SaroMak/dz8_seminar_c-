...
System.Console.WriteLine(" количесвто столбцов первой матрицы");
int columsFirstMatrix = Convert.ToInt32(Console.ReadLine());
System.Console.WriteLine(" количесвто строк первой матрицы");
int RousFirstMatrix = Convert.ToInt32(Console.ReadLine());
System.Console.WriteLine(" количесвто столбцов второй матрицы");
int columsSecondMatrix = Convert.ToInt32(Console.ReadLine());
System.Console.WriteLine(" количесвто строк второй матрицы");
